...
def encrypt():
    temp=celsius.get()
    l=Label(t,text=temp).grid(row=11,column=2)
t=Tk()
t.title('Incoginito')
t.configure(bg='pink')
l1=Label(t,text='Encryption',fg='blue',bg='red').grid(row=1,column=2)
celsius=StringVar()
fpath=StringVar()
fname=StringVar()
cclr=StringVar()
...
b1=Button(t,text='ok',command=encrypt).grid(row=10,column=2)
